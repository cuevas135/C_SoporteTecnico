<%@ Page Language="C#" AutoEventWireup="true" CodeFile="area.aspx.cs" Inherits="Cliente_area" %>
         ...
         <thead>
            ...
            <tr>
                <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3"> 
                    INGRESE DATOS AREA</td>
            </tr>
            <tr>
                <td style="text-align: right; color: #FFFFFF; background-color: #000000;">
                    Area: </td>
                <td style="text-align: left">
                    <asp:TextBox ID="AREA" runat="server" CssClass="form-control input-sm" 
                        Autocomplete = "off" placeholder="Ingresar Area" MaxLength="250" 
                        style="text-align: left" onchange="CambiaLetraMayuscula('AREA')" 
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                </td>
                <td style="text-align: left">
                    <asp:RequiredFieldValidator ID="rfvAREA" runat="server" BackColor="Yellow" 
                        ControlToValidate="AREA" ErrorMessage="*" ForeColor="Red" 
            ...
            <tr>
                ...
                <td style="text-align: left">
                   <%-- <label for="cargo">--%>
                        <asp:RangeValidator ID="rvCARGO" runat="server" BackColor="Yellow" ControlToValidate="CARGO"
                ...
                <td colspan="3">
                   <asp:Button ID="btnRegistrar" runat="server" 
                    ...
                    <asp:Button ID="btnModificar" runat="server" 
                        style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar area?');" 
                    ...
                    <asp:Button ID="btnCancelar" runat="server" class="btn btn-primary" 
                        ...
                        onclientclick="Limpiar_Datos_Area();" onclick="btnCancelar_Click" 
                        Width="15%" />
                    </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                        <asp:Table ID="Tableareas" runat="server" CssClass="form-control input" 
                            ...
                            <asp:TableRow ID="TableRow1" runat="server">
                                ...
                                <asp:TableCell ID="_AREA"  runat="server" BackColor="Black" BorderColor="Black" 
                                    ForeColor="White"  Width="40%">AREA</asp:TableCell>
                                <asp:TableCell ID="_CARGO"  runat="server" BackColor="Black" BorderColor="Black" 
                                    ForeColor="White"  Width="40%">CARGO</asp:TableCell>
