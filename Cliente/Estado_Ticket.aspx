<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Estado_Ticket.aspx.cs" Inherits="Cliente_Estado_Ticket" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        */
        ...
        function Datos_Ticket(_ID, _TICKET) {

            frmTicket.ID_ESTTICKET.value = _ID;
            frmTicket.TICKET.value = _TICKET;

        }

        function Limpiar_Datos_Ticket() {

            frmTicket.ID_ESTTICKET.value = "0";
            frmTicket.TICKET.value = "";
            ...
            <div class="table-responsive">
                ...
                <table class="table text-center">
                    ...
                    <thead>
                        ...
                        <tr>
                            <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3">INGRESE DATOS ESTADO TICKET</td>
                        </tr>
                        <tr>
                            <td style="text-align: right; color: #FFFFFF; background-color: #000000;">ESTADO TICKET: </td>
                            <td style="text-align: left">
                                <asp:TextBox ID="TICKET" runat="server" CssClass="form-control input-sm"
                                    Autocomplete="off" placeholder="Ingresar Estado Ticket" MaxLength="15"
                                    Style="text-align: left" onchange="CambiaLetraMayuscula('TICKET')"
                                    onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                            </td>
                            <td style="text-align: left">
                                <asp:RequiredFieldValidator ID="rfvTICKET" runat="server" BackColor="Yellow"
                                    ControlToValidate="TICKET" ErrorMessage="*" ForeColor="Red"
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:HiddenField ID="ID_ESTTICKET" runat="server" Value="0"
                    ...
                    <asp:Button ID="btnCancelar" runat="server" class="btn btn-primary"
                        ...
                        OnClientClick="Limpiar_Datos_Ticket();" Width="15%" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">&nbsp;</td>
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Table ID="Tabletickets" runat="server" CssClass="form-control input"
                                    ...
                                    <asp:TableRow ID="TableRow1" runat="server">
                                        ...
                                        <asp:TableCell ID="_CALNAL" runat="server" BackColor="Black" BorderColor="Black"
                                            ForeColor="White" Width="85%">CALNAL</asp:TableCell>
                                        <asp:TableCell ID="seleccionarcargo" runat="server" BackColor="Black" BorderColor="Black"
                                            ForeColor="White" Width="10%">SELECCIONAR</asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </td>
                        </tr>
