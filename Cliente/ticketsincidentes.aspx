        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        <td style="text-align: left; color: blue; background-color: white;">Canal:<asp:DropDownList ID="CANAL" runat="server" CssClass="form-control input-sm"></asp:DropDownList>
                        </td>
                        <td colspan="4" style="text-align: left; color: blue; background-color: white;">Area:<asp:DropDownList ID="AREA" runat="server" CssClass="form-control input-sm"></asp:DropDownList>
                        </td>
                    </tr>

                    <tr>
                        <td style="text-align: left; color: blue; background-color: white;">Prioridad:<asp:DropDownList ID="PRIORIDAD" runat="server" CssClass="form-control input-sm"></asp:DropDownList>
                        </td>
                        <td colspan="4" style="text-align: left; color: blue; background-color: white;">Impacto:<asp:DropDownList ID="IMPACTO" runat="server" CssClass="form-control input-sm"></asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Fecha Inicio:&nbsp;&nbsp;<asp:TextBox ID="FechaInicio" runat="server" Autocomplete="off"
                            ...
                            <button id="Fecha_Inicio" type="button">
                                ...</button><br />
                        </td>
                        ...
                        <td>Fecha Fin:&nbsp;&nbsp;<asp:TextBox ID="FechaFin" runat="server" Autocomplete="off"
                            onkeypress="BloqueaCaracteres(event)" CssClass="form-control input-sm"
                            Font-Size="Small"></asp:TextBox>
                            <button id="Fecha_Fin" type="button">
                                ...</button><br />
                        </td>
