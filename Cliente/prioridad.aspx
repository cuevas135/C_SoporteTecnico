<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prioridad.aspx.cs" Inherits="Cliente_prioridad" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Prioridad Incidente</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        */
        ...
        function Datos_Prioridad(_ID, _PRIORIDAD) {

            frmPrioridad.ID_PRIO.value = _ID;
            frmPrioridad.PRIORIDAD.value = _PRIORIDAD;

        }

        function Limpiar_Datos__Prioridad() {

            frmPrioridad.ID_PRIO.value = "0";
            frmPrioridad.PRIORIDAD.value = "";
...
<body onload="MostrarMensaje()">
    ...
    <form id="frmPrioridad" runat="server">
            ...
            <div class="table-responsive">
                ...
                <table class="table text-center">
                    ...
                    <thead>
                        ...
                        <tr>
                            <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3">INGRESE DATOS 
                    PRIORIDAD INCIDENTE</td>
                        </tr>
                        <tr>
                            <td style="text-align: right; color: #FFFFFF; background-color: #000000;">Prioridad: </td>
                            <td style="text-align: left">
                                <asp:TextBox ID="PRIORIDAD" runat="server" CssClass="form-control input-sm"
                                    Autocomplete="off" placeholder="Ingresar Prioridad" MaxLength="10"
                                    Style="text-align: left" onchange="CambiaLetraMayuscula('PRIORIDAD')"
                                    onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                            </td>
                            <td style="text-align: left">
                                <asp:RequiredFieldValidator ID="rfvPRIORIDAD" runat="server" BackColor="Yellow"
                                    ControlToValidate="PRIORIDAD" ErrorMessage="*" ForeColor="Red"
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:HiddenField ID="ID_PRIO" runat="server" Value="0"
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Button ID="btnRegistrar" runat="server"
                                    ...
                                    Text="Registrar"
                                    OnClientClick="return Confirmar('¿Desea registrar impacto?');"
                                    CssClass="btn btn-primary" Visible="False" OnClick="btnRegistrar_Click"
                                    Width="15%" />
                                &nbsp;
                    <asp:Button ID="btnModificar" runat="server"
                        Style="font-family: Calibri; color: #000000; font-size: medium"
                        Text="Modificar" OnClientClick="return Confirmar('¿Desea modificar impacto?');"
                        Visible="False" CssClass="btn btn-primary" OnClick="btnModificar_Click"
                        Width="15%" />
                                &nbsp;
                    <asp:Button ID="btnEliminar" runat="server"
                        Style="font-family: Calibri; color: #000000; font-size: medium"
                        Text="Eliminar" OnClientClick="return Confirmar('¿Desea eliminar impacto?');"
                    ...
                    <asp:Button ID="btnCancelar" runat="server" class="btn btn-primary"
                        ...
                        OnClientClick="Limpiar_Datos__Prioridad();" Width="15%" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">&nbsp;</td>
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Table ID="Tablepriopridades" runat="server" CssClass="form-control input"
                                    ...
                                    <asp:TableRow ID="TableRow1" runat="server">
                                        ...
                                        <asp:TableCell ID="_PRIORIDAD" runat="server" BackColor="Black" BorderColor="Black"
                                            ForeColor="White" Width="90%">PRIORIDAD</asp:TableCell>
    ...
    <script language="JavaScript" type="text/javascript">
        ResaltarFila('Tablepriopridades');
    </script>
