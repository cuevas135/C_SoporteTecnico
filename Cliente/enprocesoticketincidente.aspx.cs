...
public partial class Cliente_enprocesoticketincidente : System.Web.UI.Page
{
    ...
    protected void Page_init(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                servidor.ejecutar("[dbo].[enprocesoticketincidente]",
                                 false,
                                 ID_INCIDENETE,
                                 "P",
                                 0, "");
                ...
                if (servidor.getRespuesta() == 1)
                {
                    ...
                    this.__pagina.Value = "verasignacionincidentetecnico.aspx";
                }
                else
                {
