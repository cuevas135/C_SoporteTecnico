        ...
        <div class="col-md-6 col-md-offset-3">
            <table class="table table-bordered table-hover table text-center">
                <thead>
                    ...
                    <tr>
                        <td colspan="2"
                            style="text-align: center; color: #FFFFFF; background-color: #000000;">INGRESE DATOS USUARIO</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; color: #FFFFFF; background-color: #000000;">Colaborador</td>
                    ...
                    <tr>
                        <td style="text-align: center; color: #FFFFFF; background-color: #000000;">Tipo
                    Colaborador</td>
                    ...
                    <tr>
                        <td style="text-align: center; color: #FFFFFF; background-color: #000000;">Login
                        </td>
                    ...
                    <tr>
                        <td style="text-align: center; color: #FFFFFF; background-color: #000000;">Contraseña</td>
                    ...
                    <tr>
                        <td style="text-align: center; color: #FFFFFF; background-color: #000000;">Estado</td>
