            ...
            <div class="table-responsive">
                ...
                <table class="table text-center">
                    ...
                    <thead>
                        ...
                        <tr>
                            <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3">INGRESE DATOS INCIDENTE ASIGNADO</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: right; color: #FFFFFF; background-color: #000000;">Fecha atencion: </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            <td style="text-align: right; color: #FFFFFF; background-color: #000000;">Solucion incidente:</td>
                            <td style="text-align: left">
                    ...
                    <asp:Button ID="btnCancelar" runat="server" class="btn btn-primary"
                        ...
                        <tr>
                            <td colspan="3" align="left" class="style1">Seleccione incidente para ingresar fecha de atencion y solucion del incidente.</td>
                        </tr>
