<%@ Page Language="C#" AutoEventWireup="true" CodeFile="impacto.aspx.cs" Inherits="Cliente_impacto" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Impacto Incidente</title>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function Datos_Impacto(_ID, _IMPACTO) {

            frmImpacto.ID_IMP.value = _ID;
            frmImpacto.IMPACTO.value = _IMPACTO;

        }

        function Limpiar_Datos_Impacto() {

            frmImpacto.ID_IMP.value = "0";
            frmImpacto.IMPACTO.value = "";
...
<body onload="MostrarMensaje()">
    ...
    <form id="frmImpacto" runat="server">
            ...
            <div class="table-responsive">
                ...
                <table class="table text-center">
                    ...
                    <thead>
                        ...
                        <tr>
                            <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3">INGRESE DATOS IMPACTO INCIDENTE</td>
                        </tr>
                        <tr>
                            <td style="text-align: right; color: #FFFFFF; background-color: #000000;">Impacto: </td>
                            <td style="text-align: left">
                                <asp:TextBox ID="IMPACTO" runat="server" CssClass="form-control input-sm"
                                    Autocomplete="off" placeholder="Ingresar Impacto" MaxLength="9"
                                    Style="text-align: left" onchange="CambiaLetraMayuscula('IMPACTO')"
                                    onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                            </td>
                            <td style="text-align: left">
                                <asp:RequiredFieldValidator ID="rfvIMPACTO" runat="server" BackColor="Yellow"
                                    ControlToValidate="IMPACTO" ErrorMessage="*" ForeColor="Red"
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:HiddenField ID="ID_IMP" runat="server" Value="0"
                    ...
                    <asp:Button ID="btnCancelar" runat="server" class="btn btn-primary"
                        ...
                        OnClientClick=" Limpiar_Datos_Impacto();" Width="15%" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">&nbsp;</td>
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Table ID="Tableimpactos" runat="server" CssClass="form-control input"
