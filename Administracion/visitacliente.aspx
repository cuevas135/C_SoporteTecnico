    ...
    <script src="js/bootstrap-datepicker.min.js" type="text/javascript"></script>--%>
     ...
     <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
      ...
      <style type="text/css">
            ...
            .container table.restables-clone td { width: 50%; color:Black;  text-align:left;}
            .container table.restables-clone td:first-child { font-weight: bold; color:#1E90FF; text-align:right; }
    ...
    <form id="frmColaborador" role="form" runat="server" >
        <div class="panel panel-primary" style="border-style: hidden; margin: 20px;">
               ...
               <div class="panel-heading" style="text-align: center">
                      ...
                      <div class="col-md-12 col-sm-12">
                           ...
                           <div class="form-group col-md-4 col-sm-4">
                                ...
                                <asp:DropDownList ID="Tecnico" runat="server" CssClass="form-control input-sm" 
                                    ...
                                    onselectedindexchanged="Tecnico_SelectedIndexChanged"></asp:DropDownList>
                           </div>                          
                            <div class="form-group col-md-4 col-sm-4">
                                <%--<a href="#" data-toggle ="modal"  data-target ="#myModal" class="popup-link">Ver solicitudes pendientes</a> --%>   
                           </div>                                                    
                ...
                <div class="container">
                    <div class="table-responsive"> 
                        <h3 style="text-align: center" class="style1">Visitas Asignadas Tecnico</h3><br />                      
